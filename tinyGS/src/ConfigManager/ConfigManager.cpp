...
ConfigManager::ConfigManager()
    : IotWebConf2(thingName, &dnsServer, &server, initialApPassword, configVersion), server(80), gsConfigHtmlFormatProvider(*this), boards({
                                                                                                                                        ...
                                                                                                                                        {0x3c, 21, 22, 16, 0, 2, 1, 5, 0, 34, 32, 14, 19, 27, 18, 1.6f, "433Mhz FOSSA 1W Ground Station"},                               // @jgromes
                                                                                                                                        {0x3c, 21, 22, 16, 0, 2, 1, 5, 0, 34, 32, 14, 19, 27, 18, 1.6f, "868-915Mhz FOSSA 1W Ground Station"},                           // @jgromes
                                                                                                                                        {0x3c, 17, 18, 21, 0, 35, 0, 8, 14, 14, 13, 12, 11, 10, 9,1.6f,"433Mhz HELTEC WIFI LORA 32 V3"},
                                                                                                                                        {0x3c, 17, 18, 21, 0, 35, 0, 8, 14, 14, 13, 12, 11, 10, 9,1.6f,"868-915Mhz HELTEC WIFI LORA 32 V3"},
                                                                                                                                    })
{
